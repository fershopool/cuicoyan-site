...
export function renderShell(routeKey) {
  ...
  const header = el('header', { className: 'site-header' }, [
    el('div', { className: 'container header-inner' }, [
      el('a', { className: 'brand', href: routes.home, attrs: { 'aria-label': 'Cuicoyan, inicio' } }, [el('img', { src: relativeAsset('src/assets/brand/logo.svg'), alt: '' }), el('span', { text: 'Cuicoyan' })]),
      ...
      el('div', { className: 'header-tools' }, [
        el('button', { className: 'icon-button', id: 'theme-toggle', type: 'button', attrs: { 'aria-label': 'Cambiar tema', 'aria-pressed': 'false' }, text: '◐' }),
  ...
  document.body.append(el('footer', { className: 'site-footer' }, [
    el('div', { className: 'container' }, [
      el('div', { className: 'footer-grid' }, [
        el('div', { className: 'prose' }, [el('a', { className: 'brand', href: routes.home }, [el('img', { src: relativeAsset('src/assets/brand/logo.svg'), alt: '' }), el('span', { text: 'Cuicoyan' })]), el('p', { className: 'muted', text: 'Donde la ciudad encuentra su escenario.' }), el('p', { className: 'demo-label', text: 'Staging estático' })]),
